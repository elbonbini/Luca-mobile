...
function Controller() {
    ...
    function clickCentre() {
        (3 === $.leftDrawer.zIndex || 3 === $.rightDrawer.zIndex) && anim($.centreBoard, 0);
    }
    ...
    clickCentre ? $.addListener($.__views.leftDrawer, "click", clickCentre) : __defers["$.__views.leftDrawer!click!clickCentre"] = true;
    ...
    __alloyId4["templateLeft"] = __alloyId6;
    ...
    $.__views.__alloyId15 = {
        ...
        es_infoL: {
            text: "Enter new location by its details"
        }
    };
    ...
    $.__views.__alloyId10.items = __alloyId14;
    var __alloyId16 = [];
    ...
    $.__views.__alloyId17.items = __alloyId21;
    ...
    $.__views.__alloyId27 = Ti.UI.createListSection({
        headerView: $.__views.__alloyId30,
        id: "__alloyId27"
    });
    $.__views.__alloyId27.items = __alloyId31;
    __alloyId16.push($.__views.__alloyId27);
    ...
    clickCentre ? $.addListener($.__views.rightDrawer, "click", clickCentre) : __defers["$.__views.rightDrawer!click!clickCentre"] = true;
    ...
    __alloyId37["templateRight"] = __alloyId39;
    var __alloyId45 = [];
    $.__views.__alloyId46 = {
        properties: {
            backgroundColor: "#adaaab",
    ...
    $.__views.__alloyId52 = {
        properties: {
            backgroundColor: "#adaaab",
            searchableText: "charcoal, firewood, wood, grass, mats, baskets, carving",
            id: "__alloyId52"
        },
        infoR: {
    ...
    $.__views.__alloyId53 = {
        properties: {
            backgroundColor: "#adaaab",
            searchableText: "kiosk, pick-up, truck, bakkie, taxi, minibus, shop",
            id: "__alloyId53"
        },
        infoR: {
            text: "Small business"
    ...
    $.__views.__alloyId54 = {
        properties: {
            backgroundColor: "#adaaab",
            searchableText: "loan, grant, social, development, welfare, vulnerable, orphan, ovc, indigent, disability, pension, old age",
            id: "__alloyId54"
        },
        infoR: {
            text: "Formal Support"
    ...
    $.__views.__alloyId55 = {
        properties: {
            backgroundColor: "#adaaab",
            searchableText: "gift, loan, remittance, help, stokvel",
            id: "__alloyId55"
        },
        infoR: {
    ...
    $.__views.__alloyId43.items = __alloyId45;
    var __alloyId56 = [];
    __alloyId56.push($.__views.__alloyId43);
    $.__views.listRight = Ti.UI.createListView({
        ...
        headerView: $.__views.__alloyId36,
        id: "listRight",
        defaultItemTemplate: "templateRight"
    });
    ...
    $.__views.buttonLeftDrawerOpen = Ti.UI.createButton(function() {
        var o = {};
        Alloy.isHandheld && Alloy.deepExtend(true, o, {
            font: {
                fontFamily: "GillSans",
        ...
        Alloy.deepExtend(true, o, {
            ...
            tintColor: "#cccccc",
            left: 10,
            image: "images/layer-7.png",
            id: "buttonLeftDrawerOpen"
        });
        return o;
    }());
    $.__views.centreHeader.add($.__views.buttonLeftDrawerOpen);
    clickLeft ? $.addListener($.__views.buttonLeftDrawerOpen, "click", clickLeft) : __defers["$.__views.buttonLeftDrawerOpen!click!clickLeft"] = true;
    ...
    $.__views.buttonRightDrawerOpen = Ti.UI.createButton(function() {
        var o = {};
        Alloy.isHandheld && Alloy.deepExtend(true, o, {
            font: {
                fontFamily: "GillSans",
        ...
        Alloy.deepExtend(true, o, {
            ...
            tintColor: "#cccccc",
            right: 10,
            image: "images/list-fat-7.png",
            id: "buttonRightDrawerOpen"
        });
        return o;
    }());
    $.__views.centreHeader.add($.__views.buttonRightDrawerOpen);
    clickRight ? $.addListener($.__views.buttonRightDrawerOpen, "click", clickRight) : __defers["$.__views.buttonRightDrawerOpen!click!clickRight"] = true;
    ...
    $.__views.mapElement = Alloy.createController("mapcontainer", {
        id: "mapElement",
        __parentSymbol: $.__views.centreBody
    });
    ...
    var __alloyId67 = [];
    __alloyId67.push($.__views.__alloyId57);
    ...
    $.__views.interviews = Ti.UI.createTab({
        ...
        id: "interviews",
        title: "Interviews",
        icon: "images/note-write-7.png"
    });
    __alloyId0.push($.__views.interviews);
    $.__views.background = Ti.UI.createWindow({
        backgroundColor: "#0f3c50",
        top: 0,
        left: 0,
        width: Titanium.UI.FILL,
    ...
    $.__views.__alloyId68 = Ti.UI.createTab({
        window: $.__views.background,
        title: "Info",
        icon: "images/spanner-7.png",
        id: "__alloyId68"
    });
    __alloyId0.push($.__views.__alloyId68);
    $.__views.myUpdates = Ti.UI.createWindow({
        backgroundColor: "#0f3c50",
        top: 0,
        left: 0,
        width: Titanium.UI.FILL,
    ...
    $.__views.__alloyId71 = Ti.UI.createLabel(function() {
        ...
        Alloy.deepExtend(true, o, {
            text: "Announcements, user status and messages will go here",
            color: "#ffffff",
            left: "5%",
            right: "5%",
            wordWrap: "true",
    ...
    $.__views.__alloyId70 = Ti.UI.createTab({
        window: $.__views.myUpdates,
        title: "News",
        icon: "images/share-connect-7.png",
        id: "__alloyId70"
    });
    __alloyId0.push($.__views.__alloyId70);
    ...
    $.__views.__alloyId73 = Ti.UI.createLabel(function() {
        ...
        Alloy.deepExtend(true, o, {
            text: "User profile, teams and connections will go here",
            color: "#ffffff",
            left: "5%",
            right: "5%",
            wordWrap: "true",
    ...
    $.__views.__alloyId72 = Ti.UI.createTab({
        window: $.__views.myProfile,
        title: "Profile",
        icon: "images/circle-user-7.png",
        id: "__alloyId72"
    });
    __alloyId0.push($.__views.__alloyId72);
    ...
    $.__views.labelVersion = Ti.UI.createLabel(function() {
        var o = {};
        Alloy.isHandheld && Alloy.deepExtend(true, o, {
            font: {
                fontFamily: "GillSans-Light",
    ...
    $.__views.__alloyId74 = Ti.UI.createTab({
        window: $.__views.about,
        title: "About",
        icon: "images/shop-7.png",
        id: "__alloyId74"
    });
    __alloyId0.push($.__views.__alloyId74);
    ...
    initWindow("intro");
    __defers["$.__views.leftDrawer!click!clickCentre"] && $.addListener($.__views.leftDrawer, "click", clickCentre);
    __defers["$.__views.listLeft!itemclick!doItemClickL"] && $.addListener($.__views.listLeft, "itemclick", doItemClickL);
    __defers["$.__views.rightDrawer!click!clickCentre"] && $.addListener($.__views.rightDrawer, "click", clickCentre);
    __defers["$.__views.listRight!itemclick!doItemClickR"] && $.addListener($.__views.listRight, "itemclick", doItemClickR);
    __defers["$.__views.buttonLeftDrawerOpen!click!clickLeft"] && $.addListener($.__views.buttonLeftDrawerOpen, "click", clickLeft);
    __defers["$.__views.centreHeaderArea!click!clickCentre"] && $.addListener($.__views.centreHeaderArea, "click", clickCentre);
    __defers["$.__views.buttonRightDrawerOpen!click!clickRight"] && $.addListener($.__views.buttonRightDrawerOpen, "click", clickRight);
